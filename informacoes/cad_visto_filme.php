...
include('../conexao.php');
    ...
    if (isset($retorno_pedido['titulo'])) {
    	...
    	$adiciona_pedido = "UPDATE filme SET situacao = 1 WHERE idfilme = $idfilme_cadastrado;";
		mysqli_query($conexao, $adiciona_pedido);
    }
    else{

		$adiciona_pedido = "INSERT INTO filme (idTmdb, titulo, situacao, lista, url_capa, usuario_idusuario) VALUES ('$idfilme', '$nome', '1', '0', '$urlcapa', '$iduser');";
		mysqli_query($conexao, $adiciona_pedido);
