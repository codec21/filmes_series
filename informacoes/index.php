...
<style>
    ...
    table#btns_visto_add td#visto2{
        background-color: #ac4;
        color: red;
    }
...
elseif($url[0] === "filme"){
    ...
    $urlCapa = $decodeFilme['poster_path'];
    ...
    $consulta_pedido = "SELECT * FROM filme WHERE idTmdb = $idTmdbFilme and usuario_idusuario = $iduser;";
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#visto').click(function(){
            var nome = "<?php echo $tituloFilme; ?>";
            var idfilme = "<?php echo $idTmdbFilme; ?>";
            var iduser = "<?php echo $iduser; ?>";
            var urlcapa = "<?php echo $urlCapa; ?>";
            ...
            $.ajax({
                ...
                method: 'GET',
                url: "../cad_visto_filme.php",
                data: {nome: nome, idfilme: idfilme, iduser: iduser, urlcapa: urlcapa},
